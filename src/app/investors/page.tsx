      ...
      <section className="border-b border-rule">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
            ...
            <Step n="04" title="Use" body="Members book usage on the RYDA app. Each share unlocks ~30 days + ~3,000 mi per year (100 mi/day allowance); members can hold 1–10 shares per vehicle, so usage scales linearly with allocation." />
