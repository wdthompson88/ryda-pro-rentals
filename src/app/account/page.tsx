    ...
    <>
      ...
      <section className="border-b border-rule">
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-10 sm:py-16">
          ...
          <p className="mt-2 text-sm text-mute">
            Member since April 2026 · RYDA Black · Miami
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-rule">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card title="Membership" desc="RYDA Black · renews Apr 27, 2027" href="/membership" />
      ...
      <section className="border-b border-rule bg-cream-2">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10">
          ...
          <ul className="mt-6 divide-y divide-rule rounded-xl border border-rule bg-surface">
            ...
            <Activity label="Welcome to RYDA Black" detail="Annual membership active" date="2 weeks ago" />
      ...
      <section className="border-b border-rule">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10">
          ...
          <ul className="mt-6 divide-y divide-rule rounded-xl border border-rule bg-surface">
            <Charge label="White-glove delivery (Apr 28)" amount="$0" sub="Black tier — included" />
