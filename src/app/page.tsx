      ...
      <section id="how-it-works" className="border-b border-rule bg-cream-2">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 sm:py-28">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-5">
            ...
            <Step n="04" title="Drive" body="Book your time on the RYDA app. Each share unlocks ~34 days and ~3,400 miles a year (100 mi/day). Most members hold 1–2 shares; high-use members can buy more entitlement on the same car." />
            <Step n="05" title="Exit" body="Default exit: RYDA sells the car at year 2 and proceeds split pro-rata (we model a ~5% depreciation hit). Need out earlier? Transfer your share to another verified member after the 12-month minimum hold." />
          </div>
