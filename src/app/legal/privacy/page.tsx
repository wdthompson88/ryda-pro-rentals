...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      counselNote="This is a placeholder draft. Final language will be reviewed and adopted by RYDA's privacy counsel before launch. Sections below cover the topics required by CCPA, the Virginia CDPA, and (where applicable) GDPR."
      sections={[
        {
