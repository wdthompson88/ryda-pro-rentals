...
export default function DisclaimerPage() {
  return (
    <LegalPage
      ...
      counselNote="This page must be reviewed and approved by counsel before any co-ownership flow goes live. The text below is a placeholder approximation; the canonical version will be issued by counsel and may differ materially."
      sections={[
        {
