...
export default function DisclaimerPage() {
  return (
    <LegalPage
      ...
      intro="RYDA is a referral platform for luxury vehicle rentals. The vehicles listed here are owned and operated by independent rental operators. RYDA is not the lessor, does not take custody of any vehicle, and is not a party to your rental agreement. This page explains what that means in practice."
      sections={[
        {
        ...
        {
          heading: "5. Vetting is not a warranty",
