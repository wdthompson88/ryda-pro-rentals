      ...
      sections={[
        {
          ...
          body: "We target WCAG 2.1 Level AA. The site is in active development and a third-party audit is scheduled before public launch. Known areas of work-in-progress: ARIA labels on form inputs and chart controls, color-contrast verification on accent colors, and keyboard-only navigation for the buy/sell order panel.",
        },
        {
