        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <Option
              ...
              body="Contribute your car into a member-managed Delaware LLC with 5–10 vetted co-owners. You keep one or more seats, the rest are filled by RYDA-vetted members. You and your co-owners run the LLC together; RYDA handles operations."
              points={[
