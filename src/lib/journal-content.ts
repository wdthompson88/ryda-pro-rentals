...
export const POSTS: JournalPost[] = [
  {
    ...
    body: [
      ...
      "Every RYDA vehicle is Certified Pre-Owned with an active manufacturer or independent CPO warranty. The LLC is buying a known asset, not a maintenance gamble. The Operating Agreement gives members real authority — sale, replacement, modification, additional capital calls all require member supermajority, never platform discretion.",
      "## Where this lands",
