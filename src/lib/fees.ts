...
// RentalFeeBreakdown.
//
// THE SINGLE-SOURCE RULE, which is why this lives here at all. Read the
// $1,500-vs-5% incident at the top of this file: a client preview and a
// server charge computed the same fee two different ways and disagreed
// by up to $13,500. Every surface that shows a rental fee — the admin
// operator-terms preview on /admin/partners, the renter's quote, the
// booking snapshot written to rental_bookings, the Stripe call — calls
// THIS function. Nothing re-derives a fee from a rate by hand.
//
